package org.toxic.demoApp.core;
...
public class AppDemo implements IApplication {
    ...
    public void init() {
        ...
        clipped.setBackGround(new Background(0x870000FF));
        ...
        clipped.addSelectHandler(new SelectHandler() {
            ...
            public void onSelect(ActionEvent e) {
                ...
                redQuad.setBackGround(new Background(0xFFFF0000));
        ...
        main.addSelectHandler(new SelectHandler() {
            ...
            public void onSelect(ActionEvent e) {
                ...
                elem.setBackGround(new Background(0xFF00FFFF));
